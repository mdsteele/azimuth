...
static void fire_weapons(az_space_state_t *state, double time) {
      ...
      // Otherwise, fire a charged shot (no rockets).
        ...
        switch (player->gun2) {
          ...
          case AZ_GUN_PHASE:
            ...
            break;
          case AZ_GUN_BURST:
            fire_gun_multi(state, 0.0, AZ_PROJ_GUN_CHARGED_BURST, 1.0, 9,
  ...
  switch (major_gun) {
    ...
    case AZ_GUN_FREEZE:
      assert(minor_gun == AZ_GUN_NONE);
      fire_gun_single(state, 1.0, AZ_PROJ_GUN_FREEZE, AZ_SND_FIRE_GUN_FREEZE);
      return;
    case AZ_GUN_TRIPLE:
      switch (minor_gun) {
        case AZ_GUN_NONE:
          ...
          return;
        case AZ_GUN_FREEZE:
          fire_gun_multi(state, 2.0, AZ_PROJ_GUN_FREEZE, AZ_TRIPLE_DAMAGE_MULT,
    ...
    case AZ_GUN_HOMING:
      switch (minor_gun) {
        case AZ_GUN_NONE:
          fire_gun_single(state, 1.0, AZ_PROJ_GUN_HOMING,
                          AZ_SND_FIRE_GUN_NORMAL);
          return;
        case AZ_GUN_FREEZE:
          fire_gun_single(state, 1.5, AZ_PROJ_GUN_FREEZE_HOMING,
                          AZ_SND_FIRE_GUN_FREEZE);
          return;
        case AZ_GUN_TRIPLE:
          fire_gun_multi(state, 2.0, AZ_PROJ_GUN_HOMING, AZ_TRIPLE_DAMAGE_MULT,
    ...
    case AZ_GUN_PHASE:
      switch (minor_gun) {
        case AZ_GUN_NONE:
          ...
          return;
        case AZ_GUN_FREEZE:
          fire_gun_multi(state, 2.0, AZ_PROJ_GUN_FREEZE_PHASE, 1.0,
                         15, AZ_DEG2RAD(1), 0, AZ_SND_FIRE_GUN_FREEZE);
          return;
        case AZ_GUN_TRIPLE:
          fire_gun_multi(state, 3.0, AZ_PROJ_GUN_PHASE, AZ_TRIPLE_DAMAGE_MULT,
    ...
    case AZ_GUN_BURST:
      switch (minor_gun) {
        case AZ_GUN_NONE:
          ...
          return;
        case AZ_GUN_FREEZE:
          fire_gun_single(state, 3.0, AZ_PROJ_GUN_FREEZE_BURST,
                          AZ_SND_FIRE_GUN_NORMAL);
          return;
        case AZ_GUN_TRIPLE:
        ...
        case AZ_GUN_HOMING:
          ...
          return;
        case AZ_GUN_PHASE:
          fire_gun_single(state, 2.5, AZ_PROJ_GUN_PHASE_BURST,
                          AZ_SND_FIRE_GUN_NORMAL);
          return;
        default: AZ_ASSERT_UNREACHABLE();
      }
    case AZ_GUN_PIERCE:
      switch (minor_gun) {
        case AZ_GUN_NONE:
          fire_gun_single(state, 2.0, AZ_PROJ_GUN_PIERCE,
                          AZ_SND_FIRE_GUN_PIERCE);
          return;
        case AZ_GUN_FREEZE:
          fire_gun_single(state, 2.0, AZ_PROJ_GUN_FREEZE_PIERCE,
                          AZ_SND_FIRE_GUN_PIERCE);
          return;
        case AZ_GUN_TRIPLE:
          fire_gun_multi(state, 4.0, AZ_PROJ_GUN_PIERCE, AZ_TRIPLE_DAMAGE_MULT,
                         3, AZ_DEG2RAD(10), 0, AZ_SND_FIRE_GUN_PIERCE);
          return;
        case AZ_GUN_HOMING:
          fire_gun_single(state, 3.0, AZ_PROJ_GUN_HOMING_PIERCE,
                        AZ_SND_FIRE_GUN_PIERCE);
          return;
        case AZ_GUN_PHASE:
          fire_gun_multi(state, 4.0, AZ_PROJ_GUN_PHASE_PIERCE, 1.0,
                         21, AZ_DEG2RAD(1), 0, AZ_SND_FIRE_GUN_PIERCE);
          return;
        case AZ_GUN_BURST:
          fire_gun_single(state, 6.0, AZ_PROJ_GUN_BURST_PIERCE,
                          AZ_SND_FIRE_GUN_PIERCE);
          return;
        default: AZ_ASSERT_UNREACHABLE();
      }
