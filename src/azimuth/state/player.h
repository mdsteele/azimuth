...
#define AZ_DMGF_BEAM         ((az_damage_flags_t)(1u << 4))
#define AZ_DMGF_ROCKET       ((az_damage_flags_t)(1u << 5))
#define AZ_DMGF_BOMB         ((az_damage_flags_t)(1u << 6))
#define AZ_DMGF_HYPER_ROCKET ((az_damage_flags_t)(1u << 7))
